...
module.exports = () => {
  ...
  ipcRenderer.on('ELECTRON_INTERNAL_RENDERER_TAKE_HEAP_SNAPSHOT', (event, requestId, args) => {
    new Promise(resolve =>
      ...
      event.sender.send(`ELECTRON_INTERNAL_BROWSER_TAKE_HEAP_SNAPSHOT_RESULT_${requestId}`, ...responseArgs)
    })
  })
}
